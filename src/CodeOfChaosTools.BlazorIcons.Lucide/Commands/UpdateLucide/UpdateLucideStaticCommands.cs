...
using CodeOfChaosTools.BlazorIcons.Lucide.Library;
using CodeOfChaosTools.BlazorIcons.Lucide.Library.Contracts;
using CodeOfChaosTools.BlazorIcons.Lucide.Setup;
...
public partial class UpdateLucideStaticCommands : ICliCommand<UpdateLucideStaticParameters> {
    ...
    public async ValueTask ExecuteAsync(UpdateLucideStaticParameters args, CancellationToken ct = default) {
        ...
        await GlobalCatcher.ExecuteWithGlobalExceptionHandlingAsync(async () => {
            ...
            logger.Information("Saved testconfig.json to Tests.CodeOfChaos.BlazorIcons.Lucide");
            #endregion
