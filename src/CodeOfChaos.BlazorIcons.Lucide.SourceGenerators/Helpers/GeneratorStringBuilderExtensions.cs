...
public static class GeneratorStringBuilderExtensions {
    public static string[] GetLucideLicense() 
        => [
            "---",
            "ISC License",
    ...
    public static GeneratorStringBuilder WriteLucideLicense(this GeneratorStringBuilder builder) {
        foreach (string line in GetLucideLicense()) builder.AppendLine($"// {line}");
        return builder;
    }
}
